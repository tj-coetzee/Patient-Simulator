...
def clear_figures(canvas):
    # Need to iterate through child widgets and delete those, but not delete the canvas itself.
    # Get a list of all child widgets of the canvas
    child_widgets = canvas.winfo_children()
