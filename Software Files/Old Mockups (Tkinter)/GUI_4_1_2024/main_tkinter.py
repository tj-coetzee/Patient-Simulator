...
# Starts the Tkinter event loop, which is necessary for the window to display and interact with the user
# mainloop() keeps the loading window responsive, processing events such as the progress bar update and window close actions
